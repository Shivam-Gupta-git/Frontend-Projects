...
const handelGenerateButton = (event)=>{
 ...
 setInputVal(" ")
  ...
  return (
    <>
     <div className='w-full h-100 flex flex-col items-center bg-blue-300'>
      ...
      className='outline-0 border border-gray-500 w-full p-1.5 mt-2 py-2 rounded shadow-sm shadow-blue-400'/>
      
      <button 
      disabled={inputVal && inputVal.trim() !== " " ? false : true} 
      onClick={handelGenerateButton}  
      className='bg-blue-500 px-3 h-10 rounded mt-2 cursor-pointer'>Generate</button>
      </div>
