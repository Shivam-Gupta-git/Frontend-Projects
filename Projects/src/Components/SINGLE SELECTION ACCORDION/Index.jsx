            ...
            data.map((dataItem, Index) => (
              ...
              >
                ...
                >
                  ...
                  <span className=" bg-red-600 rounded p-2 flex justify-center items-center text-white text-xl h-7.5">
                    +
                  </span>
                  :
                  <span className=" bg-gray-600 rounded p-2 flex justify-center items-center text-white text-xl h-7.5">
                  +
                </span>
                  }
                </div>
